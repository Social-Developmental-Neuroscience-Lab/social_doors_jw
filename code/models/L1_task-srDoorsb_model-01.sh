...
DESC=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_decision.txt

LEFT=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_Ldecision.txt

RIGHT=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_Rdecision.txt

INS=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_instruction.txt

COR=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_correct.txt

INC=${maindir}/behavior/EVfiles/${sub}/doors/run-0${run}_b_incorrect.txt
