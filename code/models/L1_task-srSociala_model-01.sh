...
DESC=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_decision.txt

LEFT=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_Ldecision.txt

RIGHT=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_Rdecision.txt

INS=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_instruction.txt

COR=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_correct.txt

INC=${maindir}/behavior/EVfiles/${sub}/social/run-0${run}_a_incorrect.txt
